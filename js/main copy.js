...
/* 상단  GNB+ LNB 포함한 wrapper_gnb*/
// var gnb = document.getElementsByClassName("gnb");
// // 하단 스크롤 버튼
// var btnTop = document.getElementById("btnTop");
// btnTop.style.display = "none"; //초기값 숨기기

// window.addEventListener("scroll", sticky);

// function sticky() {
//   var windowPageTop = window.pageYOffset; //윈도우창에서 document 상단까지 거리
//   if (windowPageTop > gnb[0].offsetTop + 50) { //도큐먼트 gnb 클래스의 상단거리보다 커질때
//     gnb[0].classList.add("sticky"); // 클래스를 추가해서 화면을 고정함
//   } else {
//     gnb[0].classList.remove("sticky");
//   }
//   // 스크롤 위치가 0보다 커지면 버튼 스크롤 보여주기
